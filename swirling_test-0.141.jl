# Las versiones 0.14* consideran el movimiento de rotacion alrededor del eje de simetria de las particulas.
# Para este caso (0.141), se agregan las funciones que generan al sistema y una configuracion inicial de prueba.
# Junto con los ajustes a la funcion que inicia la simulacion.
...
# -- Funcion para generar una configuracion inicial de las particulas dentro de un contenedor circular -- #
...
# -- Funcion para realizar un paso de integracion de Velocity Verlet, considerando tanto la traslacion como la rotacion de las particulas -- #
...
function simular_sistema()
    ...
    # Para la funcion generar_sistema() hay que recordar colocar R y m antes del valor de los parametros, ya que sus estan valores por defecto.
    sistema = generar_sistema(n_Particulas, dimension_Sistema, R = radio_Particula, m = masa_Particula)
    ...
    archivo_salida = "resultados/giro_swirling_141.xyz"
